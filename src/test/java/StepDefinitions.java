...
//        BasePage.registerPage.enterConfirmPassword(dataTable.cell(1,4));
    ...
    {
          BasePage.registerPage.clickCreatAccountBtn();
    }
...
//         BasePage.homePage.verifyLogout();
    ...
    public void i_enter_search_text_as(String product)
    {
        BasePage.homePage.enterSearchText(product);
    }
    ...
    public void i_should_see_corresponding_results()
    {
